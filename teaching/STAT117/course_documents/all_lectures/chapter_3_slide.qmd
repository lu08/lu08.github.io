...
Example: (NELS dataset) provide interpretations for some of the statistics in the table below.  Pay attention to what statistics should not be interpretated. 
...
Example 2: San Francisco and Washington D.C. has the [same annual average temperature](https://en.wikipedia.org/wiki/List_of_cities_by_temperature){target="_blank"} of 14.6C/58.2F, however, their temperature distributions throughout the year are quite different.


Example 3: [Eruption predictions of the geysers at Yellowstone National Park](https://www.nps.gov/yell/planyourvisit/exploreoldfaithful.htm){target="_blank"}; the Old faithful geyser is famously predictable due to **consistent** historical waiting times. 
...
## Writing a thorough statistical interpretation
...
<style>
.summary-table-na {
  background-image: repeating-linear-gradient(45deg, #6ca0dc, #6ca0dc 2px, transparent 2px, transparent 10px);
}
</style>
<table style="width:100%; text-align:center; border-collapse: collapse;">
<thead>
<tr>
  <th style="border:1px solid black; padding:8px;">Level of measurement of the variable</th>
  <th style="border:1px solid black; padding:8px;">Location<br><small>(average/typical value, central tendency)</small></th>
  <th style="border:1px solid black; padding:8px;">Spread<br><small>(variability, consistency, dispersion)</small></th>
  <th style="border:1px solid black; padding:8px;">Shape<br><small>(symmetric or skewed; outliers, modality)</small></th>
</tr>
</thead>
<tbody>
<tr>
  <td style="border:1px solid black; padding:8px;"><strong>NOMINAL</strong></td>
  <td style="border:1px solid black; padding:8px;">mode</td>
  <td class="summary-table-na" style="border:1px solid black; padding:8px;"></td>
  <td class="summary-table-na" style="border:1px solid black; padding:8px;"></td>
</tr>
<tr>
  <td style="border:1px solid black; padding:8px;"><strong>ORDINAL</strong></td>
  <td style="border:1px solid black; padding:8px;">median</td>
  <td style="border:1px solid black; padding:8px;">IQR</td>
  <td class="summary-table-na" style="border:1px solid black; padding:8px;"></td>
</tr>
<tr>
  <td style="border:1px solid black; padding:8px;"><strong>SCALE</strong></td>
  <td style="border:1px solid black; padding:8px;">median (mean) </td>
  <td style="border:1px solid black; padding:8px;">IQR</td>
  <td style="border:1px solid black; padding:8px;">skewness ratio</td>
</tr>
</tbody>
</table>
```

## Additional topic 1: modality
...
hist(uniform, main = "Uniform", col = "lightgoldenrod", xlab = NA)

```

<details>
<summary>Show code (optional)</summary>
...
Example 1: [At what age do women first become mothers?](https://www.nytimes.com/interactive/2018/08/04/upshot/up-birth-age-gap.html){target="_blank"}
...
Example 2: [Old faithful Geyser](https://www.nps.gov/features/yell/ofvec/exhibits/eruption/prediction/predict7.htm){target="_blank"}
...
> These two histograms are generated using historical data of the Old Faithful Geyser at the Yellowstone National Park. Both are bimodal. The median waiting time is `r median(faithful$waiting)` minutes, and the median eruption duration is `r median(faithful$eruptions)` minutes.  These statistics alone do not accurately represent "typical" waiting times and eruption durations.


## Additional topic 2: effect of outliers
...
Simple example: number of hours slept yesterday

<p>Without outlier: 5, 6, 7, 7, 7, 8, 9</p>
...
<p>With outlier: 5, 6, 7, 7, 7, 8, **20**</p>
...
- Example 1: [How much does it typically cost to rent in Manhattan?](https://www.nytimes.com/2022/06/09/realestate/manhattan-rent-nyc.html?searchResultPosition=1){target="_blank"}
...
- Example 2: [Occupational wage statistics](https://data.bls.gov/oes/#/area/0000000/2025){target="_blank"}
...
- Example 3: [Income disclosures in MLM](https://www.reddit.com/r/antiMLM/wiki/incomedisclosures/){target="_blank"}

> Many [Multi-level marketing (MLM)](https://en.wikipedia.org/wiki/Multi-level_marketing){target="_blank"} companies quote the average earning to present a deceptive picture of typical participant earnings; the median is a more accurate representation.

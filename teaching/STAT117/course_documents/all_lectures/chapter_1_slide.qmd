...
footnote-text: "Narrative Summary on selective slides are optional. They are drafted by AI based on annotated lecture slides from previous semesters. They are fully proofread and verified by the instructor."
format:
  revealjs:
    theme: default
    slide-number: true
...
![](L1-data.png){width="950"}
![](L1-var.png){width="710"}
...
![](L1-coding1.png){width="950"}
![](L1-coding2.png){width="950"}

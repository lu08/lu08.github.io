...
subtitle: "STAT117: Introduction to Statistics<br><small><em>Narrative Summary</em> on selective slides are optional. They are drafted by AI based on annotated lecture slides from previous semesters. They are fully proofread and verified by the instructor.</small>"
format:
  revealjs:
    theme: default
    slide-number: true
